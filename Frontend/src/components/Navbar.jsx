...
const Navbar = () => {
    ...
    return (
        ...
        >
            <h1 className='text-[25px] text-shadow-2xl mb-5 md:m-0 md:text-3xl font-cinzel text-[#03071E] md:text-[#FFBA08] uppercase font-extrabold'>
                Dish & Co.
            </h1>
                ...
                currentUser ? (
                    ...
                    <div className="flex flex-col items-end gap-2">
                        ...
                        >
                            Hello{" "}
                            <motion.span
                                animate={{ scale: [1, 1.1, 1], color: ["#d2fc3a", "#FCA311", "#37d8b5"] }}
                                transition={{
                                    duration: 2.4,
                                    repeat: Infinity,
                                    ease: "easeInOut",
                        ...
                        <AnimatePresence mode="wait">
                            <motion.p
                                ...
                                className="tabular-nums text-xs sm:text-sm text-gray-600 font-poppins overflow-hidden whitespace-nowrap">
